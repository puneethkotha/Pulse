    ...
    <section className="panel">
      ...
      {stats && (
        <div className="stats-grid">
          ...
          <StatCard label="Total Interactions" value={stats.total_interactions.toLocaleString()} />
          <StatCard label="Train Interactions" value={stats.num_train.toLocaleString()} />
          <StatCard label="Val Interactions" value={stats.num_val.toLocaleString()} />
          <StatCard label="Test Interactions" value={stats.num_test.toLocaleString()} />
        </div>
      )}
